    ...
    return (
        <div>
            ...
            <p className='container'>
                ...
                personally or on behalf of an entity ("you") and Gadgefy ("Company", "we", "us", or "our"),
                concerning your access to and use of the https://gadgefy.in/ website as well as any other media
                ...
                USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms
                ...
                changes or modifications to these Terms of Use at any time and for any reason. We will alert
                you about any changes by updating the "Last Updated" date of these Terms of Use, and you
                waive any right to receive specific notice of each such change. It is your responsibility to
                periodically review these Terms of Use to stay informed of updates. You will be subject to, and
                ...
                posted. The information provided on the Site is not intended for distribution to or use by any
                ...
                if and to the extent local laws are applicable. The Site is intended for users who are at least 13
                years of age. All users who are minors in the jurisdiction in which they reside (generally under
                the age of 18) must have the permission of, and be directly supervised by, their parent or
                guardian to use the Site. If you are a minor, you must have your parent or guardian read and
                agree to these Terms of Use prior to you using the Site. INTELLECTUAL PROPERTY RIGHTS
                ...
                commercial purpose whatsoever, without our express prior written permission. Provided that you
                ...
                granted to you in and to the Site, the Content and the Marks. USER REPRESENTATIONS By
                ...
                you agree to comply with these Terms of Use; (4) you are not under the age of 13; (5) you are
                ...
                use of the Site (or any portion thereof). USER REGISTRATION You may be required to register
                with the Site. You agree to keep your password confidential and will be responsible for all use of
                ...
                or otherwise objectionable. TERMS TO SELL YOUR GADGET:- YOU ARE THE LIABLE AND
                AUTHORIZED PERSON TO SELL THE GADGET, WE ARE NOT RESPONSIBLE FOR ANY
                KIND OF LEGAL ISSUES, IF THERE IS ANY SUCH CASE OF THEFT, ROBBERY, ETC,
                YOUR THE ONLY PERSON WHO IS RESPONSIBLE FOR ALL SUCH CASES AND YOU
                CANT INCLUDE US IN SUCH CASES, WE PAID YOU IN COMPLETE SETTLEMENT AND WE
                HOLD COMPLETE RIGHT SO SELL OR USE THE PRODUCT FOR ANYTHING, AND YOU
                AGREE TO ALL THE TERMS AND CONDITIONS, WE HOLD COMPLETE RIGHT AFTER THE
                PAYMENT OF THE PRODUCT, AND YOU'RE THE BEARER OF ANY LEGEN
                CONSEQUENCES. PROHIBITED ACTIVITIES You may not access or use the Site for any
                purpose other than that for which we make the Site available. The Site may not be used in
                connection with any commercial endeavours except those that are specifically endorsed or
                approved by us. As a user of the Site, you agree not to: 1. Systematically retrieve data or other
                content from the Site to create or compile, directly or indirectly, a collection, compilation,
                database, or directory without written permission from us. 2. Trick, defraud, or mislead us and
                other users, especially in any attempt to learn sensitive account information such as user
                passwords. 3. Circumvent, disable, or otherwise interfere with security-related features of the
                Site, including features that prevent or restrict the use or copying of any Content or enforce
                limitations on the use of the Site and/or the Content contained therein. 4. Disparage, tarnish, or
                otherwise harm, in our opinion, us and/or the Site. 5. Use any information obtained from the Site
                in order to harass, abuse, or harm another person. 6. Make improper use of our support
                services or submit false reports of abuse or misconduct. 7. Use the Site in a manner
                inconsistent with any applicable laws or regulations. 8. Use the Site to advertise or offer to sell
                goods and services. 9. Engage in unauthorized framing of or linking to the Site. 10. Upload or
                ...
                Site. 11. Engage in any automated use of the system, such as using scripts to send comments
                or messages, or using any data mining, robots, or similar data gathering and extraction tools.
                12. Delete the copyright or other proprietary rights notice from any Content. 13. Attempt to
                impersonate another user or person or use the username of another user. 14. Sell or otherwise
                transfer your profile. 15. Upload or transmit (or attempt to upload or to transmit) any material
                that acts as a passive or active information collection or transmission mechanism, including
                without limitation, clear graphics interchange formats ("gifs"), 1×1 pixels, web bugs, cookies, or
                other similar devices (sometimes referred to as "spyware" or "passive collection mechanisms" or
                "PCM"). 16. Interfere with, disrupt, or create an undue burden on the Site or the networks or
                services connected to the Site. 17. Harass, annoy, intimidate, or threaten any of our employees
                or agents engaged in providing any portion of the Site to you. 18. Attempt to bypass any
                measures of the Site designed to prevent or restrict access to the Site, or any portion of the
                Site. 19. Copy or adapt the Site's software, including but not limited to Flash, PHP, HTML,
                JavaScript, or other code. 20. Decipher, decompile, disassemble, or reverse engineer any of the
                software comprising or in any way making up a part of the Site. 21. Except as may be the result
                of the standard search engine or Internet browser usage, use, launch, develop, or distribute any
                ...
                22. Use a buying agent or purchasing agent to make purchases on the Site. 23. Make any
                unauthorized use of the Site, including collecting usernames and/or email addresses of users by
                electronic or other means for the purpose of sending unsolicited email, or creating user
                accounts by automated means or under false pretences. 24. Use the Site as part of any effort to
                compete with us or otherwise use the Site and/or the Content for any revenue-generating
                endeavour or commercial enterprise.
                M./s Gadgefy, located In Bangalore (“buyer”, “we”, “us”, “our”) provides services, both online and
                offline which facilitate its customers to buy and sell used Cameras of all model Type.
                I warrant that I am eligible to contract under applicable laws and you are authorised under law to
                sell the Camera, I am the owner or authorized agent/representative of the owner of Camera and
                hence I am eligible to sell the same.
                I further warrant that the details given by me and the declaration given by me in this form
                regarding my ownership and authority is true and correct.
                I further declare that the Camera sold to you is in good, viable and useable condition and
                undertake to indemnify M/s Gadgefy in the event of any third-party claims or any claims or
                representations made by third parties.
                I further undertake that, in no event shall we i.e., M./s Gadgefy, our officers, directors, employees,
                shareholders, affiliates, or agents, be liable for direct, indirect, incidental, special, consequential
                or exemplary damages or any criminal charges towards the sold article by me herein and I am
                solely liable for any prosecution or otherwise claim made on the sold article and shall indemnify
                M./s Gadgefy in the event of any such criminal or other claims made by third parties.
                It is trite to state that, the purchaser, M./s Gadgefy, has purchased the gadget under good faith,
                relying upon the representations made by the seller and is not responsible for any wrongful
                claims made by the seller.
                I agree to defend, indemnify, keep indemnified, and hold harmless us, our officers, subsidiaries,
                shareholders, affiliates, successors, assigns, directors, officers, agents, service providers,
                suppliers and employees, from and against any and all notices, suits, proceedings, actions,
                claims, damages, harm, obligations, losses, liabilities, costs or debt, and expenses (including but
                not limited to attorneys' fees) arising from (i) any wrongful claim made by the seller; (ii) any third
                party claims and; or (iii) violation of any third party right. The seller herein validates the above
                declaration by Agreeing on the terms and conditions these terms and conditions and the same are
                binding between the parties throughout.
                USER-GENERATED CONTRIBUTIONS The Site does not offer users to submit or post content.
                ...
                you transmit may be treated in accordance with the Site Privacy Policy. When you create or
                make available any Contributions, you thereby represent and warrant that: 1. The creation,
                ...
                limited to the copyright, patent, trademark, trade secret, or moral rights of any third party. 2. You
                ...
                Contributions in any manner contemplated by the Site and these Terms of Use. 3. You have the
                ...
                Site and these Terms of Use. 4. Your Contributions are not false, inaccurate, or misleading. 5.
                Your Contributions are not unsolicited or unauthorized advertising, promotional materials,
                pyramid schemes, chain letters, spam, mass mailings, or other forms of solicitation. 6. Your
                Contributions are not obscene, lewd, lascivious, filthy, violent, harassing, libelous, slanderous, or
                otherwise objectionable (as determined by us). 7. Your Contributions do not ridicule, mock,
                disparage, intimidate, or abuse anyone. 8. Your Contributions are not used to harass or threaten
                (in the legal sense of those terms) any other person and to promote violence against a specific
                person or class of people. 9. Your Contributions do not violate any applicable law, regulation, or
                ...
                intended to protect the health or well-being of minors. 13. Your Contributions do not include any
                offensive comments that are connected to race, national origin, gender, sexual preference, or
                physical handicap. 14. Your Contributions do not otherwise violate, or link to material that
                violates any provision of these Terms of Use, or any applicable law or regulation. Any use of the
                ...
                TERMS TO BUY THE GADGET:- AFTER PURCHASING THE GADGET WE GIVE ONLY 2
                DAYS OF TESTING WARRANTY, AFTER THAT WE DO NOT ACCEPT ANY KIND OF
                RETURN OR EXCHANGE OF THE PRODUCT, ONCE THE PAYMENT IS MADE IT'S NON
                REFUNDABLE. CONTRIBUTION LICENSE
                ...
                any legal action against us regarding your Contributions. SUBMISSIONS You acknowledge and
                ...
                our sole property. We shall own exclusive rights, including all intellectual property rights, and
                ...
                misappropriation of any proprietary right in your Submissions. THIRD-PARTY WEBSITE AND
                CONTENT The Site may contain (or you may be sent via the Site) links to other websites
                ...
                through the Site or any Third-Party Content posted on, available through, or installed from the
                Site, including the content, accuracy, offensiveness, opinions, reliability, privacy practices, or
                ...
                contact with Third-Party Websites. ADVERTISERS We allow advertisers to display their
                ...
                We simply provide the space to place such advertisements, and we have no other relationship
                with advertisers. SITE MANAGEMENT We reserve the right, but not the obligation, to: (1)
                monitor the Site for violations of these Terms of Use; (2) take appropriate legal action against
                anyone who, in our sole discretion, violates the law or these Terms of Use, including without
                ...
                all files and content that are excessive in size or are in any way burdensome to our systems;
                and (5) otherwise manage the Site in a manner designed to protect our rights and property and
                to facilitate the proper functioning of the Site. PRIVACY POLICY We care about data privacy
                and security. Please review our Privacy Policy: https://gadgefy.in//privacy/. By using the Site,
                you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use.
                Please be advised the Site is hosted in India. If you access the Site from any other region of the
                ...
                transferring your data to India, and you agree to have your data transferred to and processed in
                India. TERM AND TERMINATION These Terms of Use shall remain in full force and effect while
                ...
                acting on behalf of the third party. In addition to terminating or suspending your account, we
                reserve the right to take appropriate legal action, including without limitation pursuing civil,
                criminal, and injunctive redress. MODIFICATIONS AND INTERRUPTIONS We reserve the right
                ...
                We also reserve the right to modify or discontinue all or part of the Site without notice at any
                time. We will not be liable to you or any third party for any modification, price change,
                suspension, or discontinuance of the Site. We cannot guarantee the Site will be available at all
                times. We may experience hardware, software, or other problems or need to perform
                maintenance related to the Site, resulting in interruptions, delays, or errors. We reserve the right
                to change, revise, update, suspend, discontinue, or otherwise modify the Site at any time or for
                ...
                downtime or discontinuance of the Site. Nothing in these Terms of Use will be construed to
                obligate us to maintain and support the Site or to supply any corrections, updates, or releases in
                connection therewith. GOVERNING LAW These Terms shall be governed by and defined
                following the laws of India. Gadgefy and yourself irrevocably consent that the courts of India
                shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these
                terms. DISPUTE RESOLUTION Informal Negotiations To expedite resolution and control the
                cost of any dispute, controversy, or claim related to these Terms of Use (each a "Dispute" and
                ...
                informal negotiations commence upon written notice from one Party to the other Party. Binding
                Arbitration Any dispute arising out of or in connection with this contract, including any question
                ...
                referring to it, is considered as the part of this clause. The number of arbitrators shall be three
                (3). The seat, or legal place, of arbitration, shall be New Delhi, India. The language of the
                proceedings shall be Hindi or English. The governing law of the contract shall be the substantive
                law of India. Restrictions The Parties agree that any arbitration shall be limited to the Dispute
                ...
                personal jurisdiction of that court. CORRECTIONS There may be information on the Site that
                ...
                without prior notice. DISCLAIMER THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE
                BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND OUR SERVICES WILL BE AT
                ...
                LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1) MONTH
                PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $200.00 USD. CERTAIN US
                ...
                MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS. INDEMNIFICATION
                ...
                becoming aware of it. USER DATA We will maintain certain data that you transmit to the Site for
                the purpose of managing the performance of the Site, as well as data relating to your use of the
                ...
                data. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting the
                Site, sending us emails, and completing online forms constitute electronic communications. You
                ...
                electronic means. MISCELLANEOUS These Terms of Use and any policies or operating rules
                ...
                that provision or part of the provision is deemed severable from these Terms of Use and does
                ...
                have based on the electronic form of these Terms of Use and the lack of signing by the parties
                hereto to execute these Terms of Use. CONTACT US In order to resolve a complaint regarding
                the Site or to receive further information regarding use of the Site, please contact us at: Gadgefy
                Bangalore, India Phone: 6362234448 support@gadgefy.in</p>
        </div>
    );
};
